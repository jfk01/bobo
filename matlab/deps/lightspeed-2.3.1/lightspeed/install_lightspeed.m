...
if ispc
  ...
  if strncmp(compiler,'MSVC',4)
    ...
    %mex randomseed.c util.obj random.lib  % JEBYRNE 
    %mex randbinom.c mexutil.obj util.obj random.lib % JEBYRNE
    %mex randgamma.c mexutil.obj util.obj random.lib % JEBYRNE
    %mex sample_hist.c util.obj random.lib $ JEBYRNE
  else
